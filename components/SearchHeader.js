...
export default function SearchHeader() {
  ...
  return (
    <header className='sticky top-0 gb-white'>
      <div className='flex w-full p-6 items-center'>
        ...
        <form className='flex border border-gray-200 rounded-full shadow-lg px-6 py-3 ml-10 mr-5 flex-grow max-w-3lx items-center'>
          <input
            type='text'
